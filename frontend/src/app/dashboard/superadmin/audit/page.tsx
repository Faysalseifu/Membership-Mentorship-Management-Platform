...
const mockAuditLogs: AuditLog[] = [
  ...
  },
  {
    ...
    actor: "Ustaz Musab Ibrahim",
    role: "admin",
    action: "Approved promotion for Ezadin Muzemil from Level 1 to Level 2",
  ...
  },
  {
    ...
    actor: "Ustaz Yunus Mohammed",
    role: "mentor",
    action: "Submitted Q2 evaluation for Abdi Ahmed (Aggregate: 90%)",
